...
#include "InitialShootThemUp/Public/STUGameModeBase.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	INITIALSHOOTTHEMUP_API UClass* Z_Construct_UClass_ASTUGameModeBase_NoRegister();
	INITIALSHOOTTHEMUP_API UClass* Z_Construct_UClass_ASTUGameModeBase();
	ENGINE_API UClass* Z_Construct_UClass_AGameModeBase();
	UPackage* Z_Construct_UPackage__Script_InitialShootThemUp();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_ASTUGameModeBase_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_InitialShootThemUp,
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ASTUGameModeBase, 1271563685);
	template<> INITIALSHOOTTHEMUP_API UClass* StaticClass<ASTUGameModeBase>()
	{
		return ASTUGameModeBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASTUGameModeBase(Z_Construct_UClass_ASTUGameModeBase, &ASTUGameModeBase::StaticClass, TEXT("/Script/InitialShootThemUp"), TEXT("ASTUGameModeBase"), false, nullptr, nullptr, nullptr);
